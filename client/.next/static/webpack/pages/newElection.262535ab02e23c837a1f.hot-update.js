                    ...
                    while (1) {
                      switch (_context6.prev = _context6.next) {
                        ...
                        case 3:
                          console.log(title);
                          _context6.next = 6;
                          return vote.methods.editElection(title, new Date(startDate).getTime(), new Date(endDate).getTime(), description, [0]).send({
                            from: manager
                          });
